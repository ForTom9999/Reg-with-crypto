           ...
           switch (CheckPassword.score)
            {
                case 5: case 4:
                    {
                        IsValidPasswordLBL.Text = "Nagyon Baba jelszó!!!";
                        IsValidPasswordLBL.ForeColor = Color.Green; break;
                    }

                case 3:
                    {
                        IsValidPasswordLBL.Text = "Elég erős jelszó.";
                        IsValidPasswordLBL.ForeColor = Color.Yellow; break;
                    }
                case 2:
                    {
                        IsValidPasswordLBL.Text = "Közepesen erős jelszó";
                        IsValidPasswordLBL.ForeColor = Color.Yellow; break;
                    }
                case 1: 
                    {
                        IsValidPasswordLBL.Text = "Gyenge! Nagyon gyenge!!!!";
                        IsValidPasswordLBL.ForeColor = Color.Red; break; 
                    }
                case 0:
                    {
                        IsValidPasswordLBL.Text = "Kuka! Durvább jelszó kell ide";
                        IsValidPasswordLBL.ForeColor = Color.Red; break;
                    }
